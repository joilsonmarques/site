export default {
  title: 'Título de uma página Sobre',
  embedUrl: 'https://open.spotify.com/embed/episode/7l6kyf9DCF9oTCAg3pzSnO',
  description: 'Um resumo do conteúdo da página sobre',
  members: [
    {
      id: '1',
      name: 'Heloisa Rocha',
      ...
      networks: [
        {
          name: 'Instagram',
          url: 'https://www.instagram.com/heloisapr/'
        },
        {
          name: 'Twitter',
          url: 'https://www.twitter.com/heloisapr/'
        },
        {
          name: 'Soundcloud',
          url: 'https://www.twitter.com/heloisapr/'
    ...
    },
    {
      ...
      networks: [
        ...
        {
          name: 'Facebook',
          url: 'https://www.facebook.com/karinacardoso'
        },
        {
          name: 'Youtube',
          url: 'https://www.youtube.com/kacardoso'
        }
      ]
    },
    {
      ...
      networks: [
        ...
        {
          name: 'Site',
          url: 'https://www.msarto.com/'
        },
        {
          name: 'Soundcloud',
          url: 'https://www.soundcloud.com/mario-sarto'
        },

        {
          name: 'Instagram',
          url: 'https://www.twitter.com/sarto'
        }
      ]
    }
  ]
